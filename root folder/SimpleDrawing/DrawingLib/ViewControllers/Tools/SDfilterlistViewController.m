   ...
   // cell.imageView.bounds = CGRectMake(10.0, 10.0, 45.0, 45.0);
    ...
    switch (index)
	{
		case 0:// cell.textLabel.text = @"Saturation";
            ...
            cell.inCellLabel.text = @"Brightness FX";
		...
		case 4: //cell.textLabel.text = @"Exposure";
            cell.inCellLabel.text = @"Sketch & Edges";
        ...
        case 5: //cell.textLabel.text = @"RGB";
            ...
            cell.inCellLabel.text = @"Morph FX";
        ...
        case 6:
            ...
            cell.inCellLabel.text = @"Move,Scale,Rotate";
            cell.inCellImage.image = [UIImage imageNamed:@"scalemovepreview.png"];
            cell.inCellImage.layer.cornerRadius = 5;
            cell.inCellImage.layer.masksToBounds = YES;
            break;
        case 7:
...
- (void)tableView:(UITableView *)tableView didSelectRowAtIndexPath:(NSIndexPath *)indexPath
{
   ...
   // [self newFilterSelected:indexPath];
    ...
    switch ([indexPath row]) {
        case 0:
        [self performSegueWithIdentifier:@"brightSegue" sender:self];
            break;
        ...
        case 2:
            [self performSegueWithIdentifier:@"pixelsSegue" sender:self];
            break;
        case 3:
            [self performSegueWithIdentifier:@"blurSegue" sender:self];
            break;
        case 4:
            [self performSegueWithIdentifier:@"sketchSegue" sender:self];
            break;
        case 5:
            [self performSegueWithIdentifier:@"morphSegue" sender:self];
            break;
        ...
        case 6:
        {
            ...
            NSDictionary *userInfo = [NSDictionary dictionaryWithObject:[NSNumber numberWithInt:moverNumber] forKey:@"someKey"];
    ...
    NSDictionary *userInfo = [NSDictionary dictionaryWithObject:indexPath forKey:@"someKey"];
    [[NSNotificationCenter defaultCenter] postNotificationName: @"TestNotification" object:nil userInfo:userInfo];
