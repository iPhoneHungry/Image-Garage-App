...
#import "SDsketchFilters.h"
#import <QuartzCore/QuartzCore.h>

@interface SDsketchFilters ()

@end

@implementation SDsketchFilters
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath
{
	...
	{
		case 0:
            cell.inCellLabel.text = @"Threshold 1";
           ...
           // chosen_Filter_Was = 15;
            ...
            break;
		case 1: 
            cell.inCellLabel.text = @"Threshold 2";
		...
		case 2:
            ...
            cell.inCellLabel.text = @"Threshold 3";
        ...
        case 5:
            ...
            break;
        case 7:
            cell.inCellLabel.text = @"Sketch 1";
        ...
        case 9:
            cell.inCellLabel.text = @"sketch 3";
