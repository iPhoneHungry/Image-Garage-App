...
/** strongly associates an object with the reciever.
 ...
 A strong association will cause the pointer to be set to zero
 ...
 @param key A unique key pointer.
 */
- (void)stronglyAssociateValue:(id)value withKey:(const char *)key;

/** strongly associates an object with the receiving class.
 
 @see stronglyAssociateValue:withKey:
 @param value Any object.
 @param key A unique key pointer.
 */
+ (void)stronglyAssociateValue:(id)value withKey:(const char *)key;
