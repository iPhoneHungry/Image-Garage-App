...
#else
#define ah_strong unsafe_unretained
#define __ah_strong __unsafe_unretained
#endif
#endif
...
#ifdef __i386__
{
    ...
    id<iCarouselDelegate> __ah_strong _delegate;
    id<iCarouselDataSource> __ah_strong _dataSource;
    iCarouselType _type;
...
@property (nonatomic, ah_strong) IBOutlet id<iCarouselDataSource> dataSource;
@property (nonatomic, ah_strong) IBOutlet id<iCarouselDelegate> delegate;
